...
//  AiyoyouCocoapods
//
//  Created by 黄冰珂 on 15/3/13.
//  Copyright (c) 2015年 黄冰珂. All rights reserved.
//

#define ToobarHeight 38
#import "LHPickView.h"

@interface LHPickView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
    UIDatePickerMode _datePickerMode;
}
@property (nonatomic,copy)   void (^MyBolck)(LHPickView *pickView,NSString *resutStr,NSInteger index);
...
- (instancetype)initPickviewWithArray:(NSArray *)array isHaveNavControler:(BOOL)isHaveNavControler{
    ...
    if (self) {
        ...
        [self pickerView];
        [_pickerView selectRow:(self.plistArray.count>3 ? self.plistArray.count/2 : 0) inComponent:0 animated:YES];
        [self setFrameWith:isHaveNavControler];
        [self toolbar];
    }
    return self;
