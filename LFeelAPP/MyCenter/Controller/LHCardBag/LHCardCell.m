...
- (void)setUI {
   ...
   //银行图片
    ...
    self.bankImageView.layer.cornerRadius = 50*kRatio/2;
    ...
    self.cancelBtn.titleLabel.font = kFont(15*kRatio);
    ...
    self.bankLabel.font = kFont(15*kRatio);
    ...
    self.bankClassLabel.font = kFont(15*kRatio);
    ...
    self.bankNumLabel.font = kFont(20*kRatio);
...
- (void)setUI {
    ...
    self.addLabel.font = kFont(18*kRatio);
...
- (void)setUI {
    ...
    self.cardClassLabel.font = kFont(14*kRatio);
    ...
    self.balanceRMBLabel.font = kFont(18*kRatio);
    ...
    self.commentLabel.font = kFont(14*kRatio);
    ...
    self.allRMBLabel.font = kFont(14*kRatio);
    ...
    self.timeLabel.font = kFont(14*kRatio);
