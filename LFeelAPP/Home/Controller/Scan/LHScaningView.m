...
#pragma mark - - - 扫描边角imageView的创建
    ...
    UIImage *left_image = [UIImage imageNamed:@"Home_Scan_TopLeft"];
    ...
    // 右上侧的image
    UIImage *right_image = [UIImage imageNamed:@"Home_Scan_TopRight"];
    ...
    // 左下侧的image
    UIImage *left_image_down = [UIImage imageNamed:@"Home_Scan_BottomLeft"];
    ...
    // 右下侧的image
    UIImage *right_image_down = [UIImage imageNamed:@"Home_Scan_BottomRight"];
