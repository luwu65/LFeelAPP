...
- (void)setUIWithNewHands {
    LHScrollView *scrollView = [[LHScrollView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, kScreenWidth, kScreenHeight-kNavBarHeight-kIPhoneXBottomHeight) imageArray:@[@"NewHands_01", @"NewHands_02", @"NewHands_03", @"NewHands_04", @"NewHands_05"]];
...
//清理
- (void)setUIWithClean {
    LHScrollView *scrollView = [[LHScrollView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, kScreenWidth, kScreenHeight-kNavBarHeight-kIPhoneXBottomHeight) imageArray:@[@"HomeClean_01", @"HomeClean_02", @"HomeClean_03", @"HomeClean_04"]];
    [self.view addSubview:scrollView];
}
...
- (void)setUIWithRentStep {
    LHScrollView *scrollView = [[LHScrollView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, kScreenWidth, kScreenHeight-kNavBarHeight-kIPhoneXBottomHeight) imageArray:@[@"RentStep_01", @"RentStep_02"]];
    [self.view addSubview:scrollView];
}
...
- (void)setUIWithNewHandsUnderstand {
    UITableView *understandTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, kScreenWidth, kScreenHeight-kNavBarHeight-kIPhoneXBottomHeight) style:(UITableViewStylePlain)];
